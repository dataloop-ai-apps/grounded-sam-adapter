...
# docker build --no-cache -t gcr.io/viewo-g/piper/agent/runner/apps/sam-test-runner:0.1.6 -f Dockerfile .
# docker push gcr.io/viewo-g/piper/agent/runner/apps/sam-test-runner:0.1.6
